# -*- coding: utf-8 -*-
"""
Created on Wed Oct 26 13:29:15 2016
...
branch_ngram_2.add(Convolution2D(100, 3, ACTION_MAX_LENGHT, input_shape=(1,ACTIVITY_MAX_LENGHT,ACTION_MAX_LENGHT),border_mode='valid',activation='relu'))
branch_ngram_2.add(MaxPooling2D(pool_size=(ACTIVITY_MAX_LENGHT-3+1,1))) # 1-max-pool

branch_ngram_3= Sequential()
branch_ngram_3.add(Convolution2D(100, 4, ACTION_MAX_LENGHT, input_shape=(1,ACTIVITY_MAX_LENGHT,ACTION_MAX_LENGHT),border_mode='valid',activation='relu'))
branch_ngram_3.add(MaxPooling2D(pool_size=(ACTIVITY_MAX_LENGHT-4+1,1))) # 1-max-pool

branch_ngram_4= Sequential()
branch_ngram_4.add(Convolution2D(100, 5, ACTION_MAX_LENGHT, input_shape=(1,ACTIVITY_MAX_LENGHT,ACTION_MAX_LENGHT),border_mode='valid',activation='relu'))
branch_ngram_4.add(MaxPooling2D(pool_size=(ACTIVITY_MAX_LENGHT-5+1,1))) # 1-max-pool
