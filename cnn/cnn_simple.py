...
classifier.add(Convolution2D(100, 2, ACTION_MAX_LENGHT, input_shape=(1,ACTIVITY_MAX_LENGHT,ACTION_MAX_LENGHT),border_mode='valid',activation='relu'))
...
print 'Training...'
sys.stdout.flush()
classifier.fit(X, y, batch_size=128, nb_epoch=300, validation_data=(X_test, y_test))
print 'Saving model...'
sys.stdout.flush()
